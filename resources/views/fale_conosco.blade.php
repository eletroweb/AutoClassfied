    ...
    <div class="col-sm-6">
      ...
      <form action="{{route('fale_conosco_post')}}" class="bg-light p-4 m-4" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nome" id="nome" aria-describedby="nomeHelp" placeholder="Qual o seu nome?" required>
          <small id="nomeHelp" class="form-text text-muted">Digite o seu nome completo.</small>
        </div>
        <div class="form-group">
          <label for="email">E-mail:</label>
          <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Informe o seu e-mail de contato" required>
          <small id="emailHelp" class="form-text text-muted">Entraremos em contato com você através do e-mail informado.</small>
        </div>
        <div class="form-group">
          <label for="cpf">CPF:</label>
          <input type="text" class="form-control" name="cpf" id="cpf" aria-describedby="cpfHelp" placeholder="Digite o seu CPF" required>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="celular" id="celular" aria-describedby="celularHelp" placeholder="Digite o seu número de celular">
          <small id="celularHelp" class="form-text text-muted">Caso utilize o celular, você pode informá-lo aqui.</small>
        </div>
        <div class="form-group">
          <label for="assunto">Assunto:</label>
          <input type="text" class="form-control" name="assunto" id="assunto" aria-describedby="assuntoHelp" placeholder="Qual o motivo do seu contato?" required>
          <small id="assuntoHelp" class="form-text text-muted">Seja curto e objetivo para o fácil entendimento.</small>
        </div>
        <div class="form-group">
          <label for="mensagem">Mensagem:</label>
          <textarea class="form-control" id="mensagem" name="mensagem" rows="5" placeholder="Olá, estou entrando em contato para..." required></textarea>
