              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h3>Olá {{$contato->getAnuncio()->users->name}},</h3>
                        <p>Você recebeu o contato de um visitante no anúncio {{$contato->getAnuncio()->nome}}:</p>
                        <p>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Este é um e-mail automático e não deve ser respondido.</span>
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Todos os direitos reservados - <a href="http://unicodono.com.br">UNICODONO</a>.
                  </td>
                </tr>
              </table>
            </div>
